...
import com.andriod.reader.di.AppModule_ProvideGitHubApiFactory;
import com.andriod.reader.di.AppModule_ProvideGsonFactory;
import com.andriod.reader.di.AppModule_ProvideOkHttpClientFactory;
import com.andriod.reader.ui.editor.EditorViewModel;
...
public final class DaggerReaderApplication_HiltComponents_SingletonC {
  private DaggerReaderApplication_HiltComponents_SingletonC() {
  }
  ...
  public static final class Builder {
    ...
    public ReaderApplication_HiltComponents.SingletonC build() {
      Preconditions.checkBuilderRequirement(applicationContextModule, ApplicationContextModule.class);
      return new SingletonCImpl(applicationContextModule);
    }
  }

  private static final class ActivityRetainedCBuilder implements ReaderApplication_HiltComponents.ActivityRetainedC.Builder {
    ...
    @Override
    public ReaderApplication_HiltComponents.ActivityRetainedC build() {
      Preconditions.checkBuilderRequirement(savedStateHandleHolder, SavedStateHandleHolder.class);
      return new ActivityRetainedCImpl(singletonCImpl, savedStateHandleHolder);
    }
  }

  private static final class ActivityCBuilder implements ReaderApplication_HiltComponents.ActivityC.Builder {
    private final SingletonCImpl singletonCImpl;
    ...
    @Override
    public ReaderApplication_HiltComponents.ActivityC build() {
      Preconditions.checkBuilderRequirement(activity, Activity.class);
      return new ActivityCImpl(singletonCImpl, activityRetainedCImpl, activity);
    }
  }

  private static final class FragmentCBuilder implements ReaderApplication_HiltComponents.FragmentC.Builder {
    private final SingletonCImpl singletonCImpl;
    ...
    @Override
    public ReaderApplication_HiltComponents.FragmentC build() {
      Preconditions.checkBuilderRequirement(fragment, Fragment.class);
      return new FragmentCImpl(singletonCImpl, activityRetainedCImpl, activityCImpl, fragment);
    }
  }

  private static final class ViewWithFragmentCBuilder implements ReaderApplication_HiltComponents.ViewWithFragmentC.Builder {
    private final SingletonCImpl singletonCImpl;
    ...
    @Override
    public ReaderApplication_HiltComponents.ViewWithFragmentC build() {
      Preconditions.checkBuilderRequirement(view, View.class);
      return new ViewWithFragmentCImpl(singletonCImpl, activityRetainedCImpl, activityCImpl, fragmentCImpl, view);
    }
  }

  private static final class ViewCBuilder implements ReaderApplication_HiltComponents.ViewC.Builder {
    private final SingletonCImpl singletonCImpl;
    ...
    @Override
    public ReaderApplication_HiltComponents.ViewC build() {
      Preconditions.checkBuilderRequirement(view, View.class);
      return new ViewCImpl(singletonCImpl, activityRetainedCImpl, activityCImpl, view);
    }
  }

  private static final class ViewModelCBuilder implements ReaderApplication_HiltComponents.ViewModelC.Builder {
    private final SingletonCImpl singletonCImpl;
    ...
    @Override
    public ReaderApplication_HiltComponents.ViewModelC build() {
  ...
  private static final class ServiceCBuilder implements ReaderApplication_HiltComponents.ServiceC.Builder {
    private final SingletonCImpl singletonCImpl;
    ...
    @Override
    public ReaderApplication_HiltComponents.ServiceC build() {
      Preconditions.checkBuilderRequirement(service, Service.class);
      return new ServiceCImpl(singletonCImpl, service);
    }
  }

  private static final class ViewWithFragmentCImpl extends ReaderApplication_HiltComponents.ViewWithFragmentC {
    private final SingletonCImpl singletonCImpl;
  ...
  private static final class FragmentCImpl extends ReaderApplication_HiltComponents.FragmentC {
    private final SingletonCImpl singletonCImpl;
  ...
  private static final class ViewCImpl extends ReaderApplication_HiltComponents.ViewC {
    private final SingletonCImpl singletonCImpl;
  ...
  private static final class ActivityCImpl extends ReaderApplication_HiltComponents.ActivityC {
    private final SingletonCImpl singletonCImpl;
  ...
  private static final class ViewModelCImpl extends ReaderApplication_HiltComponents.ViewModelC {
    ...
    private static final class SwitchingProvider<T> implements Provider<T> {
      ...
      public T get() {
        switch (id) {
          case 0: // com.andriod.reader.ui.editor.EditorViewModel 
          return (T) new EditorViewModel(viewModelCImpl.savedStateHandle, singletonCImpl.noteRepositoryProvider.get());
          ...
          return (T) new SettingsViewModel(singletonCImpl.settingsStoreProvider.get(), singletonCImpl.syncRepositoryProvider.get());
  ...
  private static final class ActivityRetainedCImpl extends ReaderApplication_HiltComponents.ActivityRetainedC {
    private final SingletonCImpl singletonCImpl;
  ...
  private static final class ServiceCImpl extends ReaderApplication_HiltComponents.ServiceC {
    private final SingletonCImpl singletonCImpl;
  ...
  private static final class SingletonCImpl extends ReaderApplication_HiltComponents.SingletonC {
    ...
    private Provider<SyncStateStore> syncStateStoreProvider;
    ...
    private void initialize(final ApplicationContextModule applicationContextModuleParam) {
      ...
      this.syncStateStoreProvider = DoubleCheck.provider(new SwitchingProvider<SyncStateStore>(singletonCImpl, 2));
      this.noteFileStoreProvider = DoubleCheck.provider(new SwitchingProvider<NoteFileStore>(singletonCImpl, 1));
      this.noteRepositoryProvider = DoubleCheck.provider(new SwitchingProvider<NoteRepository>(singletonCImpl, 0));
      this.settingsStoreProvider = DoubleCheck.provider(new SwitchingProvider<SettingsStore>(singletonCImpl, 4));
      this.provideOkHttpClientProvider = DoubleCheck.provider(new SwitchingProvider<OkHttpClient>(singletonCImpl, 7));
      this.provideGitHubApiProvider = DoubleCheck.provider(new SwitchingProvider<GitHubApi>(singletonCImpl, 6));
      this.syncRepositoryProvider = DoubleCheck.provider(new SwitchingProvider<SyncRepository>(singletonCImpl, 5));
    }

    @Override
    public void injectReaderApplication(ReaderApplication readerApplication) {
    }
    ...
    private static final class SwitchingProvider<T> implements Provider<T> {
      ...
      public T get() {
        switch (id) {
          case 0: // com.andriod.reader.data.repository.NoteRepository 
          return (T) new NoteRepository(singletonCImpl.noteFileStoreProvider.get(), singletonCImpl.syncStateStoreProvider.get());

          case 1: // com.andriod.reader.data.local.NoteFileStore 
          return (T) new NoteFileStore(ApplicationContextModule_ProvideContextFactory.provideContext(singletonCImpl.applicationContextModule), singletonCImpl.syncStateStoreProvider.get());

          case 2: // com.andriod.reader.data.local.SyncStateStore 
          ...
          case 4: // com.andriod.reader.data.remote.SettingsStore 
          ...
          case 5: // com.andriod.reader.data.repository.SyncRepository 
          ...
          case 6: // com.andriod.reader.data.remote.GitHubApi 
